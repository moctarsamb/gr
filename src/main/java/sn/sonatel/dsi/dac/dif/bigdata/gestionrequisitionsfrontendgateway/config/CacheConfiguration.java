...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("gestionrequisitionsfrontendgateway");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("gestionrequisitionsfrontendgateway");
        ...
        config.getMapConfigs().put("sn.sonatel.dsi.dac.dif.bigdata.gestionrequisitionsfrontendgateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
