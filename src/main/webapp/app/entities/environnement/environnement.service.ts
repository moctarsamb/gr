...
export class EnvironnementService {
    public resourceUrl = SERVER_API_URL + 'api/environnements';
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/environnements';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IEnvironnement[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
