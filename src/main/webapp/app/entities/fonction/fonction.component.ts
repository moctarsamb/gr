...
export class FonctionComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.fonctionService
                ...
                .subscribe(
                    (res: HttpResponse<IFonction[]>) => this.paginateFonctions(res.body, res.headers),
    ...
    registerChangeInFonctions() {
        this.eventSubscriber = this.eventManager.subscribe('fonctionListModification', response => this.reset());
    }
    ...
    protected paginateFonctions(data: IFonction[], headers: HttpHeaders) {
