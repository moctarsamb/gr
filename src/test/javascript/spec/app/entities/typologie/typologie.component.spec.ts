...
import { TypologieComponent } from 'app/entities/typologie/typologie.component';
...
describe('Component Tests', () => {
    describe('Typologie Management Component', () => {
        let comp: TypologieComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TypologieComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.typologies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
