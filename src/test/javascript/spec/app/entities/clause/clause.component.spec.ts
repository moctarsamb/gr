...
import { ClauseComponent } from 'app/entities/clause/clause.component';
    ...
    describe('Clause Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ClauseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.clauses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
