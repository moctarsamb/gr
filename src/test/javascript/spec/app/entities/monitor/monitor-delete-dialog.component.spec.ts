...
import { MonitorDeleteDialogComponent } from 'app/entities/monitor/monitor-delete-dialog.component';
import { MonitorService } from 'app/entities/monitor/monitor.service';

describe('Component Tests', () => {
    describe('Monitor Management Delete Component', () => {
        let comp: MonitorDeleteDialogComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MonitorDeleteDialogComponent, '')
                .compileComponents();
