    ...
    describe('Monitor Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MonitorComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.monitors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
