...
import { IBase, Base } from 'app/shared/model/base.model';
...
describe('Service Tests', () => {
    describe('Base Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Base(0, 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Base', async () => {
                const returnedFromService = Object.assign(
                    {
                        libelle: 'BBBBBB',
                        description: 'BBBBBB'
