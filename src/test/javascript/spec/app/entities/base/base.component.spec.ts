    ...
    describe('Base Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BaseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bases[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
