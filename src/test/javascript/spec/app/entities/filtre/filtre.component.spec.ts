...
import { FiltreComponent } from 'app/entities/filtre/filtre.component';
import { FiltreService } from 'app/entities/filtre/filtre.service';
import { Filtre } from 'app/shared/model/filtre.model';

describe('Component Tests', () => {
    describe('Filtre Management Component', () => {
        let comp: FiltreComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FiltreComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.filtres[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
