...
import { ProvenanceComponent } from 'app/entities/provenance/provenance.component';
...
describe('Component Tests', () => {
    describe('Provenance Management Component', () => {
        let comp: ProvenanceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProvenanceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.provenances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
