...
import { JointureComponent } from 'app/entities/jointure/jointure.component';
...
describe('Component Tests', () => {
    describe('Jointure Management Component', () => {
        let comp: JointureComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(JointureComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.jointures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
